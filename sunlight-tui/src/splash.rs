...
impl SplashScreen {
    ...
    fn draw_header(&mut self) {
        ...
        font::draw_str(&mut self.fb, left_x + 16, left_y, "SunlightOS", palette::TEXT, 1);
        ...
        font::draw_str(&mut self.fb, right_x, left_y, right_str, palette::TEXT_DIM, 1);
    }
    ...
    fn draw_footer(&mut self) {
        ...
        // Clear footer first
        self.fb.fill_rect(footer.x, footer.y, footer.w, footer.h, palette::SURFACE);
        ...
        font::draw_str(&mut self.fb, left_x, left_y, "Status: ", palette::TEXT_DIM, 1);
        font::draw_str(&mut self.fb, left_x + 64, left_y, self.footer.kernel_status, status_color, 1);
