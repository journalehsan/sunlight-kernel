...
//! ## Silhouette origin
//!
//! `WORLD_MAP_BITS` is a project-owned equirectangular monochrome silhouette
//! (180×90) authored for this widget: stylized but more recognizable continents
//! (Americas, Greenland, UK/Europe, Africa, Arabia, India, East Asia, Japan,
//! Madagascar, Australia, New Zealand, Antarctica). It is **not** derived from
//! the colorful timezone design reference and carries no labels, legend, city
//! data, or timezone borders. Geometry is independent of the city catalog.
//!
//! ## Scope
//!
...
pub const WORLD_MAP_W: u32 = 180;
/// Embedded silhouette height (rows). Aspect is exactly 2∶1.
pub const WORLD_MAP_H: u32 = 90;

/// Row-major bit-packed silhouette (`WORLD_MAP_W` bits per row, MSB first).
///
/// Origin: improved SunlightOS-authored outline (see module docs).
/// 2025 bytes at 180×90 (was 120×60 / 900 bytes).
pub static WORLD_MAP_BITS: [u8; 2025] = [
    ...
    ,
    ...
    ,
...
mod tests {
    ...
    fn silhouette_has_land_and_ocean() {
        ...
        // 180×90: southern ice around y≈80–85; mid-Atlantic ~lon -30°.
        assert!(land_at_texel(90, 85));
        assert!(!land_at_texel(0, 0));
        let atl_x = ((-30.0_f32 + 180.0) / 360.0 * WORLD_MAP_W as f32) as u32;
        let atl_y = ((90.0_f32 - 0.0) / 180.0 * WORLD_MAP_H as f32) as u32;
        assert!(!land_at_texel(atl_x, atl_y));
        // Recognizable land near major catalog cities (projection identity check).
        for (lon, lat) in [(-74.0, 40.7), (51.4, 35.7), (139.7, 35.7), (151.2, -33.9)] {
            let x = ((lon + 180.0) / 360.0 * WORLD_MAP_W as f32) as u32;
            let y = ((90.0 - lat) / 180.0 * WORLD_MAP_H as f32) as u32;
            assert!(
                land_at_texel(x.min(WORLD_MAP_W - 1), y.min(WORLD_MAP_H - 1)),
                "expected land near lon={lon} lat={lat}"
            );
        }
    }
    ...
    fn write_combined_widget_preview() {
        use crate::widgets::{DigitalNumberWidget, SolarClockSnapshot, SolarClockWidget};
