...
"#,
    ...
    RamEntry::file("/bin/ls", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/cat", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/cp", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/mv", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/rm", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/mkdir", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/rmdir", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/touch", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/find", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/grep", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/head", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/tail", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/wc", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/sort", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/uniq", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/cut", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/file", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/stat", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/pwd", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/date", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/whoami", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/id", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/uname", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/echo", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/bin/nice", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    ...
    RamEntry::file("/bin/sunlightctl", 0, 0, mode::FILE_755, b"#!/sunlight/sunlightctl\n"),
    RamEntry::file("/bin/nicectl", 0, 0, mode::FILE_755, b"#!/sunlight/nicectl\n"),
    RamEntry::file("/bin/capabilityctl", 0, 0, mode::FILE_755, b"#!/sunlight/capabilityctl\n"),
    ...
    RamEntry::file("/sbin/sunlight-sm", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-sm\n"),
    ...
    RamEntry::file("/bin/curl", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-net-utils\n"),
    RamEntry::file("/bin/dig", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-net-utils\n"),
    RamEntry::file("/bin/nslookup", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-net-utils\n"),
    RamEntry::file("/bin/hostname", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-net-utils\n"),
    RamEntry::file("/bin/netstat", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-net-utils\n"),
    RamEntry::file("/bin/ss", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-net-utils\n"),
    RamEntry::file("/bin/traceroute", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-net-utils\n"),
    RamEntry::file("/bin/arp", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-net-utils\n"),
    RamEntry::file("/bin/dhclient", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-net-utils\n"),
    ...
    RamEntry::file("/sunlight-utils/whoami", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/sunlight-utils/id", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/sunlight-utils/uname", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/sunlight-utils/nice", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/sunlight-utils/renice", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/sunlight-utils/free", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
    RamEntry::file("/sunlight-utils/freezram", 0, 0, mode::FILE_755, b"#!/sunlight/sunlight-utils\n"),
...
[Install]\nWantedBy=sunlight.target\n",
    ...
    RamEntry::file("/usr/bin/fetch", 0, 0, mode::FILE_755, b"#!/sunlight/fetch\n"),
];
