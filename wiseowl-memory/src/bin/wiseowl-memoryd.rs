//! wiseowl-memoryd — host-side short-term memory daemon.
//!
//! Listens on a Unix domain socket with length-prefixed bincode frames
//! (same framing convention as sunlight-kv host mode).
